...
Divination 与 Drawing 是两个独立项目，各自在自己的目录维护 README、CURRENT_STATUS、DECISION_EVENTS。Zhanbu 只保留目录与站点入口，不拥有第三份产品状态或决定版本。

| 独立项目 | 定位 | 项目事实源 |
|---|---|---|
| Divination | 多端综合占卜工具 | [README](Divination/README.md) · [状态](Divination/CURRENT_STATUS.md) · [Events](Divination/DECISION_EVENTS.md) |
| Drawing | 梵天神策 99 签 PWA | [README](Drawing/README.md) · [状态](Drawing/CURRENT_STATUS.md) · [Events](Drawing/DECISION_EVENTS.md) |
...
- 本次只拆分记录，未调整仓库、源码、部署路径、数据文件或产物，也不重开已完成项目。
