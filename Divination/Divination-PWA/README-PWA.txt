...
三、说明
  · 当前共十五个模块。手机宽度下按四列四行显示，使用六爻纳甲、塔罗牌、雷诺曼牌、玄天灵签、
    梅花易数、太乙神数、择日黄历等正式名称；第一行为首页、择日黄历、复古神谕和中英切换。
    手机六爻的上卦、下卦位于第一行，动爻选择独占第二行。
  ...
  · 应用图标使用黑衣小魔法师原图；PWA 离线缓存版本为 divination-v22。
  · 支持子标签、特殊牌开关、页面状态缓存、每模块30条历史
    （localStorage 持久化）及复制提示“已复制”。不同设备的历史不会自动同步。
  · 标签自适应屏宽，桌面第一排的择日/黄历紧跟灵签，第二排可横向滚动；深色模式自动适配。
