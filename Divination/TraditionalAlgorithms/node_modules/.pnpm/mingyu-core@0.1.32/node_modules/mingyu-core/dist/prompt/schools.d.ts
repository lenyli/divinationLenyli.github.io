...
export declare const PROMPT_SCHOOL_PROFILES: {
    ...
    readonly xuankong: {
        readonly sanYuan: {
            ...
            readonly category: "断法";
            readonly task: "以建造时间所属三元九运和当前运势为背景，判断各星当运、退运与未来作用。";
            readonly basis: "玄空飞星三元九运与九星旺衰的通行资料。";
        };
        readonly shanxiang: {
    ...
    readonly qizheng: {
        readonly guolao: {
            ...
            readonly category: "流派";
            readonly task: "以命身宫、七政四余、星曜落宫与二十八宿为骨架，结合主要吊照形成判断。";
            readonly basis: "《果老星宗》的命身、星曜、宫位与吊照资料。";
        };
